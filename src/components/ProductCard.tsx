      ...
      <div className="p-4">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            className="mt-4 w-full bg-red-700 text-white px-4 py-2 rounded-md hover:bg-red-800 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
          >
            {loading ? (
